% Appendix — ProsodyPrompt evaluation results
...
% ============================================================
\chapter{ProsodyPrompt Prosody Output: English Minimal-Pair Corpus}
\label{app:english}
% ============================================================
...
The analysis was produced by the full ProsodyPrompt pipeline: WhisperX (large-v3,
...
in Hz) and ProsodyPrompt prosody symbol.
...
% ============================================================
\chapter{German GToBI Training Sentences: Human Annotation vs.\ ProsodyPrompt}
\label{app:german}
% ============================================================

Five GToBI-annotated German training sentences were processed with ProsodyPrompt.
...
\section*{ProsodyPrompt prosody output (pYIN + 5 optimisations, hardcoded IPA)}
...
vowel nucleus) and the ProsodyPrompt prosody symbol.
...
ProsodyPrompt was run twice on the same recording using the nearest available
...
stage. The final ProsodyPrompt pipeline for Daakie does not use ASR at all:
...
% ============================================================
\chapter{ProsodyPrompt: Installation and CLI Reference}
\label{app:speechprint_cli}
% ============================================================

\begin{center}
\fbox{\parbox{0.88\linewidth}{\centering\vspace{2mm}
\textbf{Navigate to the ProsodyPrompt repository:}\\[2mm]
\texttt{https://github.com/speechprint/ProsodyPrompt}\\[2mm]
...
ProsodyPrompt is a prosody annotation environment and field-research toolkit.
...
\begin{verbatim}
git clone https://github.com/speechprint/ProsodyPrompt
cd ProsodyPrompt/linux
export SPEECHPRINT_ROOT="$PWD"
uv run python -m lib.main        # opens the launcher GUI
\end{verbatim}

On first run, select \textbf{Install ProsodyPrompt} to configure all
...
These tools connect the ProsodyPrompt symbolic prosody layer to
...
Convert a ProsodyPrompt prosody TextGrid tier to a VocalTractLab
