...
\begin{figure}
    ...
    \caption{Realization of vowels by an English speaker, adapted from \cite{whalen}.}
...
In linguistics, the consistent annotation of prosodic information is less developed than the annotation of phonemes. While the IPA contains symbols for tones, to be used in particular for tone languages that use F0 also for the distinction of lexical meaning, they are far less used. Also, many different systems of prosodic annotation have been developed, and there is no general agreement \cite{hirst2022}. The most widespread use is ToBI \cite{beckmann2006}, but this is language-specific and combines aspects of prosodic form and of prosodic function.
